...
layui.config({
	...
	//帖子信息展示
	AjaxPostUtil.request({url: sysMainMation.admBasePath + "queryForumContentById", params: {id: rowId}, type: 'json', callback: function (json) {
	...
	$("body").on("click", "#forumCommentAdd", function (e) {
		...
		if(isNull(replyContent)){
			...
			AjaxPostUtil.request({url: sysMainMation.admBasePath + "insertForumCommentMation",
				params: {
					forumId: rowId,
	...
	function loadCommentList(){
		...
		showGrid({
		 	...
		 	ajaxSendAfter:function(j){
		 		AjaxPostUtil.request({url: sysMainMation.admBasePath + "queryForumCommentList", params: {forumId: rowId}, type: 'json', callback: function (json) {
					var row = json.rows;
