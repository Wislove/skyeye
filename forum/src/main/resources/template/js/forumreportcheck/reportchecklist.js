...
layui.config({
    ...
    function showNoCheckList() {
        ...
        table.render({
            ...
            method: 'post',
            url: sysMainMation.admBasePath + 'queryReportNoCheckList',
            where: {
                keyword: $("#reportOtherContent").val(),
                startTime: reportstartTime,
                endTime: reportendTime,
                state: '1',
                typrId: $("#reportType").val(),
            },
            even: false,
            page: true,
            ...
            cols: [[
                ...
                {
                    field: 'forumMation.forumTitle', title: '帖子标题', align: 'center', width: 250, templet: function (d) {
                        return '<a lay-event="forumdetails" class="notice-title-click">' + d.forumMation.forumTitle + '</a>';
                    }
                },
                {
                    field: 'reportTypeId', title: '举报类型', align: 'center', width: 120, templet: function (d) {
        ...
        function loadTable() {
            ...
            table.reloadData("messageNoCheckTable", {
                where: {
                    tkeyword: $("#reportOtherContent").val(),
                    startTime: reportstartTime,
                    endTime: reportendTime,
                    state: '1',
                    typrId: $("#reportType").val(),
    ...
    function showCheckedList() {
        ...
        table.render({
            ...
            url: sysMainMation.admBasePath + 'queryReportNoCheckList',
            where: {
                keyword: $("#checkedtitle").val(),
                startTime: checkedreportstartTime,
                endTime: checkedreportendTime,
                state: '2',
                typrId: $("#checkedReportType").val(),
                // reportTypeId: $("#checkedReportType").val(),
                // examinestartTime: checkedexaminestartTime,
                // examineendTime: checkedexamineendTime,
            },
            even: false,
            page: true,
            limits: [8, 16, 24, 32, 40, 48, 56],
        ...
        function loadCheckedTable() {
            ...
            table.reloadData("messageCheckedTable", {
                where: {
                    keyword: $("#checkedtitle").val(),
                    startTime: checkedreportstartTime,
                    endTime: checkedreportendTime,
